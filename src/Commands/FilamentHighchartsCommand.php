...
namespace Koassi\FilamentHighcharts\Commands;
...
class FilamentHighchartsCommand extends Command
{
     ...
     * @var string
     */
    public $signature = 'make:filament-highcharts {name?}';
     ...
     * @var string
     */
    public $description = 'Creates a Filament Highcharts Widget class.';
    ...
    public function __construct(Filesystem $files)
    {
        ...
        $this->files = $files;
        $this->chartOptions = config('filament-highcharts.chart_options');
    }
    ...
    private function welcomeMessage(): void
    {
        if ($this->confirm('Would you like to show some love by starring the repo?', true)) {
            if (PHP_OS_FAMILY == 'Darwin') {
                exec('open https://github.com/KoassiAkakpo/filament-highcharts');
            }
            if (PHP_OS_FAMILY == 'Windows') {
                exec('start https://github.com/KoassiAkakpo/filament-highcharts');
            }
            if (PHP_OS_FAMILY == 'Linux') {
                exec('xdg-open https://github.com/KoassiAkakpo/filament-highcharts');
            }
