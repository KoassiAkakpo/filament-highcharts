@php
$plugin = (function_exists('filament') && filament()->isServing()) ? \Koassi\FilamentHighcharts\FilamentHighchartsPlugin::get() : null;
...
<x-filament-widgets::widget class="fi-wi-chart filament-widgets-chart-widget filament-highcharts-widget">
    <x-filament::section
        class="filament-highcharts-section"
