...
<div class="filament-highcharts-filter-form relative">
    ...
    <div x-show="dropdownOpen" x-cloak @class([ 'absolute mt-2 z-20 w-screen divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 transition dark:divide-gray-700 dark:bg-gray-800 dark:ring-white/20' ,
        ])
        style="{{ match ($width) {
        ...
        <div class="py-4 px-6">
            ...
            <div class="mt-2 text-end flex gap-6 justify-end">
                ...
                <x-filament::link wire:click="resetFiltersForm" color="danger" tag="button" size="sm">
                    {{ __('filament-highcharts::filters.reset.label') }}
                </x-filament::link>
            </div>
        </div>
